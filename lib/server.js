...
var MIN_TO_REDISTRIBUTE = "1"; // 100 sats, about 0.03 cents
var MIN_PRICE = {
    USDC: MIN_MATIC_USD,
    WBTC: MIN_MATIC_BTC,
};
...
var MIN_REWARDS = ethers_1.BigNumber.from("100000000000000000");
// Expected 0.0018 per hour
// 0.001 which should happen 10 times per hjour
var MIN_DCA_REWARDS = ethers_1.BigNumber.from("1000");
...
var checkDCAVault = function (vault) { return __awaiter(void 0, void 0, void 0, function () {
    var vaultContract, stratContract, toSwap, swapTx, err_4, toSwap, balanceInContract, depositTx, err_5, currentRewards, expectedHarvest, harvestTx, err_6, shouldInvest, investTx, err_7, balanceOfNeed, distributionTx, err_8;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                ...
                if (!toSwap.gt(MIN_TO_SWAP)) return [3 /*break*/, 5];
                return [4 /*yield*/, vaultContract.swapToNeed(MIN_PRICE[vault.need.symbol])];
            case 3: return [4 /*yield*/, (_a.sent()).wait()];
            case 4:
                swapTx = _a.sent();
            ...
            case 6:
                err_4 = _a.sent();
                console.log("Exception in SwapToNeed", err_4);
                return [3 /*break*/, 7];
            case 7:
                console.log("/** CHECK DEPOSITS **/");
                _a.label = 8;
            ...
            case 10:
                balanceInContract = _a.sent();
                console.log("balanceInContract", balanceInContract.toString());
                if (!balanceInContract.sub(toSwap).gt(0)) return [3 /*break*/, 13];
                return [4 /*yield*/, stratContract.deposit(balanceInContract, {
                        gasLimit: 5000000,
                    })];
            ...
            case 14:
                err_5 = _a.sent();
                console.log("Exception in check deposits", err_5);
                return [3 /*break*/, 15];
            case 15:
                console.log("/** CHECK HARVEST **/");
                _a.label = 16;
            case 16:
                _a.trys.push([16, 22, , 23]);
                return [4 /*yield*/, stratContract.getRewardsAmount()];
            case 17:
                currentRewards = _a.sent();
                console.log("currentRewards", currentRewards.toString());
            ...
            case 18:
                ...
                if (!currentRewards.gt(MIN_DCA_REWARDS)) return [3 /*break*/, 21];
                console.log("Will harvest");
                return [4 /*yield*/, stratContract.harvest(MIN_PRICE[vault.want.symbol], {
                        gasLimit: 5000000,
                    })];
            case 19: return [4 /*yield*/, (_a.sent()).wait()];
            case 20:
                harvestTx = _a.sent();
                console.log("harvestTx", harvestTx.transactionHash);
                _a.label = 21;
            ...
            case 22:
                err_6 = _a.sent();
                console.log("Exception in harvest", err_6);
                return [3 /*break*/, 23];
            case 23:
                console.log("/** CHECK REBALANCE **/");
                _a.label = 24;
            case 24:
                _a.trys.push([24, 29, , 30]);
                return [4 /*yield*/, stratContract.shouldInvest()];
            case 25:
                shouldInvest = _a.sent();
                console.log("shouldInvest", shouldInvest);
                if (!shouldInvest) return [3 /*break*/, 28];
                return [4 /*yield*/, stratContract.invest({
                        gasLimit: 5000000,
                    })];
            case 26: return [4 /*yield*/, (_a.sent()).wait()];
            case 27:
                investTx = _a.sent();
                console.log("investTx", investTx.transactionHash);
                _a.label = 28;
            ...
            case 29:
                err_7 = _a.sent();
                console.log("Exception in rebalance", err_7);
                return [3 /*break*/, 30];
            case 30:
            ...
            case 32:
                ...
                if (!balanceOfNeed.gt(MIN_TO_REDISTRIBUTE)) return [3 /*break*/, 35];
                return [4 /*yield*/, vaultContract.distributeNeed({ gasLimit: 10000000 })];
            case 33: return [4 /*yield*/, (_a.sent()).wait()];
            case 34:
            ...
            case 36:
                err_8 = _a.sent();
                console.log("Exception in distributeNeed", err_8);
                return [3 /*break*/, 37];
...
//   while (vaultsToLoop.length || dcaVaultsToLoop.length) {
...
node_cron_1.default.schedule("*/2 * * * *", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("Every 2 minutes, for dcaVaults");
