...
var CONTRACT_ADDRESS = "0x9dB2A331fbD4cEA56450f3A0a9b983bC52ec7387";
...
node_cron_1.default.schedule("*/1 * * * *", function () { return __awaiter(void 0, void 0, void 0, function () {
    var wallet, contract, balance, reinvest, err_1, canBorrow, rebalance, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                contract = new ethers_1.Contract(CONTRACT_ADDRESS, CONTRACT_ABI, wallet);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 7, , 8]);
                return [4 /*yield*/, contract.getRewardsBalance()];
            case 2:
                balance = _a.sent();
                console.log("balance", balance);
                if (!balance.gt(ethers_1.utils.parseUnits("0.5", "ether"))) return [3 /*break*/, 5];
                console.log("Reinvesting");
                return [4 /*yield*/, contract.reinvestRewards({ gasLimit: 600000 })];
            ...
            case 8:
                ...
                return [4 /*yield*/, contract.canBorrow()];
            case 9:
                canBorrow = _a.sent();
                console.log("");
                if (!canBorrow.gt(ethers_1.utils.parseUnits("5", "ether"))) return [3 /*break*/, 12];
                return [4 /*yield*/, contract.rebalance({ gasLimit: 6000000 })];
