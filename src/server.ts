...
const CONTRACT_ADDRESS = "0x9dB2A331fbD4cEA56450f3A0a9b983bC52ec7387";
  ...
  try {
    ...
    if (balance.gt(utils.parseUnits("0.5", "ether"))) {
      ...
      const reinvest = await (
        await contract.reinvestRewards({ gasLimit: 600000 })
      ).wait();
